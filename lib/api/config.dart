...
class APIConfig {
  ...
  final String API_DOMAIN = 'api.openweathermap.org';
  ...
  String composeCurrentWeatherApiURL(String locationName) {
    return '$API_URL/weather?appid=$API_KEY&q=$locationName&units=metric';
  }

  String composeWeatherForecastApiURL(double lat, double lon) {
    return '$API_URL/onecall?appid=$API_KEY&lat=${lat.toString()}&lon=${lon.toString()}&units=metric';
  }
}
